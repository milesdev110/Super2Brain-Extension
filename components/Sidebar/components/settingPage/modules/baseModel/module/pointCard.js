...
const PointsCard = ({ setIsShowModal, setActiveTab, pointCosts, setIsAddPoint }) => {
          ...
          <div className="flex flex-col space-y-2">
            {pointCostArray.map(({ name, points }) => (
              <div key={name} className="flex justify-between items-center">
                ...
                <span className="text-indigo-600 font-medium">{points} 积分/次</span>
              </div>
            ))}
          </div>
