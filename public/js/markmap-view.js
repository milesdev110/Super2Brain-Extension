...
!(function (t, e) {
  ...
  const l = 1,
    ...
    u = { show: d, actuate: d, href: d },
    p = (t) => "string" == typeof t || "number" == typeof t,
    m = (t) => (null == t ? void 0 : t.vtype) === l,
    f = (t) => (null == t ? void 0 : t.vtype) === c;
  function g(t, e, ...n) {
    return (function (t, e) {
      let n;
      if ("string" == typeof t) n = l;
      else {
  ...
  function b(t, e, n, r) {
    if (((e = k[e] || e), !0 === n)) t.setAttribute(e, "");
    else if (!1 === n) t.removeAttribute(e);
    else {
      const i = r ? u[e] : void 0;
  ...
  function w(t, e = y) {
    ...
    if (p(t)) return document.createTextNode(`${t}`);
    if (m(t)) {
      let n;
  ...
  const A =
    ...
    O = {
      ...
      color: (t) => {
        var e;
        return M(`${(null == (e = t.state) ? void 0 : e.path) || ""}`);
      },
      duration: 500,
      embedGlobalCSS: !0,
      fitRatio: 0.95,
  ...
  const N = "http://www.w3.org/2000/svg",
    ...
    $ = { show: T, actuate: T, href: T },
    R = (t) => "string" == typeof t || "number" == typeof t,
    B = (t) => 1 === (null == t ? void 0 : t.vtype),
    L = (t) => 2 === (null == t ? void 0 : t.vtype);
  function I(t, e) {
    let n;
  ...
  function Y(t, e, n, r) {
    if (((e = P[e] || e), !0 === n)) t.setAttribute(e, "");
    else if (!1 === n) t.removeAttribute(e);
    else {
      const i = r ? $[e] : void 0;
      void 0 !== i ? t.setAttributeNS(i, e, n) : t.setAttribute(e, n);
  ...
  function W(t, e = H) {
    ...
    if (R(t)) return document.createTextNode(`${t}`);
    if (B(t)) {
      let n;
      const { type: r, props: i } = t;
      if (
  ...
  function nt(t) {
    ...
    function i() {
      const t = n("nodeSize"),
        e = n("spacing");
      return class n extends U.prototype.constructor {
        constructor(t) {
          super(t);
        }
        copy() {
  ...
  const rt = (t, e = 0) => (
    ...
    it = (t, e, n) => {
      ...
      return (
        ...
        (t.prelim = 0),
        (t.x = n + t.relX),
        (t.children || []).forEach((e) => it(e, r, t.x)),
        t
      );
    },
    at = (t) => {
    ...
    ct = (t) => (t.hasChildren ? t.firstChild : t.lThr),
    ht = (t) => (t.hasChildren ? t.lastChild : t.rThr),
    dt = (t, e, n, r) => {
  ...
  class St {
    constructor(t, i) {
      (this.options = O),
        ...
        (this.handleClick = (t, e) => {
          ...
          (A ? t.metaKey : t.ctrlKey) && (n = !n), this.toggleNode(e.data, n);
        }),
        ...
        (this.debouncedRefresh = (function (t, e) {
          const n = { timer: 0 };
          function r() {
    ...
    getStyleContent() {
      ...
      return [this.options.embedGlobalCSS && gt, n].filter(Boolean).join("\n");
    }
    updateStyle() {
      this.svg.attr(
        "class",
    ...
    initializeData(t) {
      ...
      const p = Array.from(l.childNodes).map((t) => t.firstChild);
      this._checkImages(l),
        p.forEach((t) => {
          var e;
          null == (e = t.parentNode) || e.append(t.cloneNode(!0));
        }),
        a(t, (t, e, n) => {
          var i;
          const a = t.state,
    ...
    renderData(t) {
      ...
      const {
        ...
        l = nt({})
          ...
          .nodeSize((t) => {
            const [e, i] = t.data.state.size;
            return [i, e + (e ? 2 * r : 0) + n];
          })
          .spacing((t, e) => (t.parent === e.parent ? i : 2 * i)),
        c = l.hierarchy(this.state.data);
      l(c);
      const h = c.descendants().reverse(),
        d = c.links(),
        u = e.linkHorizontal(),
        p = e.min(h, (t) => t.x - t.xSize / 2),
      ...
      const v = (t && h.find((e) => e.data === t)) || c,
        ...
        k = this.g.selectAll(o("g")).data(h, (t) => t.data.state.key),
        b = k
          .enter()
          .append("g")
          .attr("data-depth", (t) => t.data.state.depth)
      ...
      this.transition(z)
        .attr("x1", -1)
        .attr("x2", (t) => t.ySize - n + 2)
        .attr("y1", (t) => t.xSize)
        .attr("y2", (t) => t.xSize)
        .attr("stroke", (t) => s(t.data))
        .attr("stroke-width", yt);
      const E = w
        .selectAll(o("circle"))
        .data(
          (t) => {
      ...
      const C = w
        ...
        .attr("width", (t) => Math.max(0, t.ySize - n - 2 * r))
        .attr("height", (t) => t.xSize);
      this.transition(C).style("opacity", 1);
      const j = this.g
        .selectAll(o("path"))
        .data(d, (t) => t.target.data.state.key)
        .join(
          (t) => {
            const e = [x + v.ySize - n, y + v.xSize / 2];
            return t
              .insert("path", "g")
              .attr("class", "markmap-link")
              .attr("data-depth", (t) => t.target.data.state.depth)
              .attr("data-path", (t) => t.target.data.state.path)
              .attr("d", u({ source: e, target: e }));
          },
          (t) => t,
          (t) => {
            const e = [v.y + v.ySize - n, v.x + v.xSize / 2];
      ...
      this.transition(j)
        .attr("stroke", (t) => s(t.target.data))
        .attr("stroke-width", (t) => yt(t.target))
        .attr("d", (t) => {
          const e = t.source,
            r = t.target,
            i = [e.y + e.ySize - n, e.x + e.xSize / 2],
            a = [r.y, r.x + r.xSize / 2];
          return u({ source: i, target: a });
        }),
        h.forEach((t) => {
          (t.data.state.x0 = t.x), (t.data.state.y0 = t.y);
        });
    }
    transition(t) {
    ...
    async fit() {
      const t = this.svg.node(),
        ...
        { fitRatio: a } = this.options,
        { minX: o, maxX: s, minY: l, maxY: c } = this.state,
        h = c - l,
        d = s - o,
    ...
    async ensureView(t, n) {
      ...
      const o = this.svg.node(),
        { spacingHorizontal: s } = this.options,
        ...
        v = f[0] * f[1] > 0 ? xt(f, Math.abs) / c.k : 0,
      ...
      await Promise.all(
        t.map((t) =>
          (async function (t) {
            ...
            if ((t.loaded || (t.loaded = j[e]), !t.loaded)) {
              const n = s();
              (t.loaded = n.promise),
                e && (j[e] = t.loaded),
                "style" === t.type
...
//# sourceMappingURL=/sm/576e40e89b450bbcf4142e50a16a2086a9a145874bbed0aee8be9ef422ec2fab.map
