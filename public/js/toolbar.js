...
!(function (t) {
  ...
  const g = { isSvg: !1 };
  function v(t, A) {
    Array.isArray(A) || (A = [A]), (A = A.filter(Boolean)).length && t.append(...A);
  }
  ...
  function m(t, A) {
    return Array.isArray(t) ? t.map((t) => m(t, A)).reduce((t, A) => t.concat(A), []) : f(t, A);
  }
  function f(t, A = g) {
    ...
    if (s(t)) {
      ...
      if (
        ...
        (e = A.isSvg ? document.createElementNS(r, i) : document.createElement(i)),
        (function (t, A, e) {
          for (const r in A)
            if ("key" !== r && "children" !== r && "ref" !== r)
              if ("dangerouslySetInnerHTML" === r) t.innerHTML = A[r].__html;
                ...
                const e = A[r];
                null != e && (t[r] = e);
              } else r.startsWith("on") ? (t[r.toLowerCase()] = A[r]) : d(t, r, A[r], e.isSvg);
        })(e, n, A),
        n.children)
      ) {
        let t = A;
        A.isSvg && "foreignObject" === i && (t = Object.assign({}, t, { isSvg: !1 }));
  ...
  let z = y;
  (t.Toolbar = z), Object.defineProperty(t, Symbol.toStringTag, { value: "Module" });
